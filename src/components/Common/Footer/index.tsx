    ...
    return (
        <footer>
            ...
            <div id="div-como-encontrar">
                ...
                >
                    <AiFillInstagram className="icones-como-encontrar" />
                </a>
                <a
                    ...
                    rel="noopener noreferrer"
                >
                    <IoMail className="icones-como-encontrar" />
                </a>
                <a
                    ...
                    rel="noopener noreferrer"
                >
                    <FaLinkedinIn className="icones-como-encontrar" />
                </a>
                <a
                    ...
                    rel="noopener noreferrer"
                >
                    <FaYoutube className="icones-como-encontrar" />
                </a>
                <a
                    ...
                    rel="noopener noreferrer"
                >
                    <FaGithub className="icones-como-encontrar" />
                </a>
            </div>
        </footer>
    );
